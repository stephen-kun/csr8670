...
static const uint8 gaia_service_record[] =
{
    ...
    0x08,    0,             /* 23 24     uint8 RFCOMM channel */
...
{
    uint8 *sr = malloc(sizeof gaia_service_record);
    ...
    {
        memcpy(sr, gaia_service_record, sizeof gaia_service_record);
        sr[GAIA_SR_CH_IDX] = channel;
