...
.linefile 14 "cvc_FrontEnd.asm" 2
...
.linefile 15 "cvc_FrontEnd.asm" 2
...
.MODULE $cbops.scratch;
   .DATASEGMENT DM;
    ...
    .VAR/DMCIRC mem4[120]; .VAR cbuffer_struc4[$cbuffer.STRUC_SIZE] = LENGTH(mem4), &mem4, &mem4;
    .VAR/DMCIRC mem5[120]; .VAR cbuffer_struc5[$cbuffer.STRUC_SIZE] = LENGTH(mem5), &mem5, &mem5;

.ENDMODULE;
.linefile 63 "cvc_FrontEnd.asm"
.MODULE $adc_in;
   .DATASEGMENT DM;
.linefile 76 "cvc_FrontEnd.asm"
    .VAR/DMCIRC left.mem[$BLOCK_SIZE_ADC_DAC * 2]; .VAR left.cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(left.mem), &left.mem, &left.mem;
    .VAR/DMCIRC right_mem[$BLOCK_SIZE_ADC_DAC * 2]; .VAR right.cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(right_mem), &right_mem, &right_mem;
    .VAR/DMCIRC sidetone_mem[(4*$SAMPLE_RATE_DAC)/1000]; .VAR sidetone_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(sidetone_mem), &sidetone_mem, &sidetone_mem;
   ...
   .VAR copy_struc[] =
      ...
      $cbops.scratch.cbuffer_struc3,
      $cbops.scratch.cbuffer_struc4,
      $cbops.scratch.cbuffer_struc5;
...
.linefile 192 "cvc_FrontEnd.asm"
    ...
    .BLOCK hw_copy_right_op;
        .VAR hw_copy_right_op.mtu_next = &copy_op_right;
    ...
    .BLOCK sidetone_copy_op;
        ...
        .VAR sidetone_copy_op.param[($cbops.sidetone_filter_op.PEQ_START_FIELD + ($audio_proc.peq.STRUC_SIZE + 2*((3)+1) ))] =
            ...
            $M.CVC_HEADSET_2MIC.CONFIG.SIDETONEENA,
            &$M.CVC.data.CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_ST_CLIP_POINT,
            0,
            0.0,
            ...
            0,
            &$dac_out.auxillary_mix_op.param+$cbops.aux_audio_mix_op.OFFSET_INV_DAC_GAIN,
            0,
            0,
            ...
            0,
            3,
            &$M.CVC.data.CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_ST_PEQ_CONFIG,
            0 ...;
    .ENDBLOCK;
...
.ENDMODULE;
.linefile 353 "cvc_FrontEnd.asm"
.MODULE $dac_out;
   .DATASEGMENT DM;
.linefile 368 "cvc_FrontEnd.asm"
    ...
    .BLOCK sidetone_mix_op;
        ...
        .VAR sidetone_mix_op.main_next = &pk_out_dac;
    ...
    .BLOCK pk_out_dac;
      .VAR pk_out_dac.mtu_next = &sidetone_mix_op;
