.linefile 1 "cvc_headset_2mic_config.asm"
.linefile 1 "<command-line>"
.linefile 1 "cvc_headset_2mic_config.asm"
.linefile 20 "cvc_headset_2mic_config.asm"
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/stack.h" 1
.linefile 21 "cvc_headset_2mic_config.asm" 2
...
.linefile 22 "cvc_headset_2mic_config.asm" 2
...
.linefile 23 "cvc_headset_2mic_config.asm" 2
...
.linefile 24 "cvc_headset_2mic_config.asm" 2
...
.linefile 25 "cvc_headset_2mic_config.asm" 2
.linefile 1 "cvc_headset_2mic.h" 1
.linefile 11 "cvc_headset_2mic.h"
...
.linefile 12 "cvc_headset_2mic.h" 2
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_headset_2mic_config.h" 1
.linefile 13 "cvc_headset_2mic.h" 2
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_headset_2mic_library_gen.h" 1
.linefile 12 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_headset_2mic_library_gen.h"
...
.linefile 108 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_headset_2mic_library_gen.h"
...
.linefile 14 "cvc_headset_2mic.h" 2
...
.linefile 22 "cvc_headset_2mic.h" 2
.linefile 32 "cvc_headset_2mic.h"
...
.linefile 206 "cvc_headset_2mic.h"
...
.linefile 282 "cvc_headset_2mic.h"
...
.CONST $M.CVC_HEADSET_2MIC.CONFIG.BYPASS_RCVOMS $M.CVC_HEADSET_2MIC.CONFIG.RCVOMSENA;
.linefile 26 "cvc_headset_2mic_config.asm" 2
...
.linefile 27 "cvc_headset_2mic_config.asm" 2
...
.linefile 28 "cvc_headset_2mic_config.asm" 2
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cbuffer.h" 1
.linefile 29 "cvc_headset_2mic_config.asm" 2
...
.linefile 30 "cvc_headset_2mic_config.asm" 2
...
.ENDMODULE;
.linefile 39 "cvc_headset_2mic_config.asm" 2
.linefile 70 "cvc_headset_2mic_config.asm"
.MODULE $M.CVC_MODULES_STAMP;
   ...
   .BLOCK ModulesStamp;
      ...
      .VAR s2 = 0xfeeb;
      .VAR s3 = 0xfeeb;
      .VAR CompConfig = 0*0x020000 + 0*0x010000 + 1*0x008000 + 1*0x004000 + 1*0x002000 + 1*0x001000 + 1*0x000800 + 1*0x000400 + 1*0x000200 + 1*0x000100 + 1*0x000080 + 1*0x000040 + 1*0x000020 + 1*0x000010 + 1*0x000008 + 1*0x000004 + 1*0x000002 + 1*0x000001;
      .VAR s4 = 0xfeeb;
      .VAR s5 = 0xfeeb;
      .VAR s6 = 0xfeeb;
   .ENDBLOCK;
.ENDMODULE;
.linefile 92 "cvc_headset_2mic_config.asm"
...
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_headset_2mic_defaults_WB.dat" 1
...
0x0000, 0xCF7F, 0xFFFF,
0x093F, 0xB309, 0x3FB3,
0x0000, 0x06EE, 0xFF96,
...
0x4000, 0x003D, 0xCC9A,
0x8466, 0xCC3D, 0xCC9A,
0x3BAC, 0x9584, 0x7A2C,
0x4821, 0x4187, 0x0599,
0x62F9, 0xCF2B, 0x1B12,
0x8705, 0x99FA, 0x9856,
0x0005, 0x0469, 0x3027,
0xE3C8, 0x7E00, 0x0504,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
...
0x0000, 0x2000, 0x008D,
0x1009, 0xB900, 0x0001,
0x4000, 0x000B, 0x4CE0,
0x0400, 0x0005, 0xA670,
0x7F9B, 0xCE00
.linefile 122 "cvc_headset_2mic_config.asm" 2
   ;
   .VAR/DMCONST16 DefaultParameters_fe[] =
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_headset_2mic_defaults_FE.dat" 1
...
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0008,
0x0000, 0x1000, 0x008D,
0x1009, 0xB900, 0x0001,
0x4000, 0x000B, 0x4CE0,
0x0400, 0x0005, 0xA670,
0x7F9B, 0xCE00
.linefile 125 "cvc_headset_2mic_config.asm" 2
   ;
   .VAR/DMCONST16 DefaultParameters_nb[] =
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_headset_2mic_defaults_NB.dat" 1
...
0x0000, 0x0000, 0x0000,
0x0000, 0x0100, 0x0001,
0x4000, 0x003B, 0xAC83,
0x88A6, 0xF93B, 0xAC83,
0x37A3, 0xF988, 0xF1EA,
0x4821, 0x4187, 0x0599,
0x62F9, 0xCF2B, 0x1B12,
0x8705, 0x99FA, 0x9856,
0x0005, 0x0469, 0x3027,
...
0x0400, 0x0005, 0xA670,
0x7F9B, 0xCE00
.linefile 128 "cvc_headset_2mic_config.asm" 2
   ;
 ...
 .VAR/DM2 fft_circ[($M.filter_bank.Parameters.FFT256_BUFFLEN * 2)];
   ...
   .ENDBLOCK;
.linefile 241 "cvc_headset_2mic_config.asm"
   ...
   .VAR dcblock_parameters_wb[] =
        ...
        1;
.linefile 281 "cvc_headset_2mic_config.asm"
...
.CONST $RCV_HARMONICITY_HISTORY_EXTENSION $M.CVC.Num_Samples_Per_Frame;
   ...
   .VAR/DM1 RcvAnalysisBank[$M.filter_bank.Parameters.ONE_CHNL_BLOCK_SIZE] =
      ...
      &stream_map_rcvin,
      &bufd_rcv_inp+$RCV_HARMONICITY_HISTORY_EXTENSION,
      0,
      &X_real,
      &X_imag,
      0 ...;
   ...
   .VAR oms270rcv_obj[$M.oms270.STRUC_SIZE] =
        ...
        &AEQ_DataObject + $M.AdapEq.AEQ_POWER_TEST_FIELD,
         ...
         oms270rcv_obj + $M.oms270.PTR_Y_REAL_FIELD,
         oms270rcv_obj + $M.oms270.PTR_X_REAL_FIELD,
         0,
         &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_RCV_OMS_HFK_AGGR,
         0 ...;
   ...
   .VAR/DM2 rcv_peq_dm2[($audio_proc.peq.STRUC_SIZE + 2*(((5))+1) )] =
      ...
      &stream_map_rcvout,
      (5),
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_RCV_PEQ_CONFIG,
      0 ...;
   ...
   .VAR/DM1 rcvout_gain_dm2[$M.audio_proc.stream_gain.STRUC_SIZE] =
      &stream_map_rcvout,
      &stream_map_rcvout,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_RCVGAIN_MANTISSA,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_RCVGAIN_EXPONENT;
   ...
   .VAR/DM1 rcv_vad400[$M.vad400.OBJECT_SIZE_FIELD] =
      &vad_peq_output,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_RCV_VAD_ATTACK_TC,
      0 ...;
   ...
   .VAR/DM rcv_agc400_dm[$M.agc400.STRUC_SIZE] =
      0,
      0,
      $M.CVC_HEADSET_2MIC.CONFIG.BYPASS_AGCPERSIST,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_RCV_AGC_G_INITIAL,
      &stream_map_rcvout,
      &stream_map_rcvout,
   ...
   .VAR/DM AEQ_DataObject[$M.AdapEq.STRUC_SIZE] =
      ...
      $M.CVC_HEADSET_2MIC.CONFIG.BEXENA,
      ...
      1,
      2,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_AEQ_LO_GOAL_LOW,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_AEQ_HI_GOAL_LOW,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_BEX_TOTAL_ATT_LOW,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_BEX_HI2_GOAL_LOW,
      0,
      21771,
      14,
      33,
   ...
   .VAR sco_in_pk_dtct[] =
      &stream_map_rcvin,
      0;
.linefile 634 "cvc_headset_2mic_config.asm"
...
.linefile 663 "cvc_headset_2mic_config.asm"
  .VAR fba_dm[$M.filter_bank.Parameters.TWO_CHNL_BLOCK_SIZE] =
   ...
   .VAR/DM1 AecAnalysisBank[$M.filter_bank.Parameters.ONE_CHNL_BLOCK_SIZE] =
      ...
      &X_real,
      &X_imag,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_REF_DELAY,
      &ref_delay_buffer,
      &ref_delay_buffer,
   ...
   .VAR/DM2 SndSynthesisBank[$M.filter_bank.Parameters.ONE_CHNL_BLOCK_SIZE] =
      ...
      .VAR mgdc100_obj[$mgdc100.STRUC_SIZE] =
               &D0,
               &D1,
               &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_MGDC_MAXCOMP,
               &$cvc_fftbins,
               &in0oms_G,
               0,
               &$cvc.dmss_mode,
   ...
   .VAR dms100_obj[$dms100.STRUC_SIZE] =
         ...
         &D0,
         &D1,
         &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_DMS_AGGR,
         &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_DMSS_LPN_MIC,
         &$cvc.dmss_mode,
         &spp,
         0 ...;
   ...
   .VAR/DM1 mute_cntrl_dm1[$M.MUTE_CONTROL.STRUC_SIZE] =
      &stream_map_sndout,
      &$M.CVC_SYS.CurCallState,
      $M.CVC_HEADSET_2MIC.CALLST.MUTE;
   ...
   .VAR/DM2 snd_peq_dm2[($audio_proc.peq.STRUC_SIZE + 2*(((5))+1) )] =
      ...
      &stream_map_sndout,
      (5),
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_SND_PEQ_CONFIG,
      0 ...;
   ...
   .VAR vad_echo_hold[$M.CVC.vad_hold.STRUC_SIZE] =
      ...
      &rcv_vad400 + $M.vad400.FLAG_FIELD,
      0,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_SND_AGC_ECHO_HOLD_TIME,
      0 ...;
   ...
   .VAR vad_noise_hold[$M.CVC.vad_hold.STRUC_SIZE] =
      ...
      0,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_SND_AGC_NOISE_HOLD_TIME,
      0 ...;
   ...
   .VAR/DM1 out_gain_dm1[$M.audio_proc.stream_gain.STRUC_SIZE] =
      &stream_map_sndout,
      &stream_map_sndout,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_SNDGAIN_MANTISSA,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_SNDGAIN_EXPONENT;
   ...
   .VAR/DM snd_agc400_dm[$M.agc400.STRUC_SIZE] =
      ...
      0,
      0,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_SND_AGC_G_INITIAL,
      &stream_map_sndout,
      &stream_map_sndout,
   ...
   .VAR/DM1 ndvc_dm1[$M.NDVC_Alg1_0_0.BLOCK_SIZE +$M.NDVC_Alg1_0_0.MAX_STEPS] =
      ...
      &in0oms_LpXnz,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_NDVC_HYSTERESIS,
      0 ...;
...
.ENDBLOCK;
   ...
   .VAR/DM1 asf_object[$asf100.STRUC_SIZE] =
      ...
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_ASF_MIC_DISTANCE,
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_DMSS_LPN_MIC,
      $M.dm1_scratch,
      $M.dm2_scratch,
      $asf100.app_prep,
   ...
   .VAR/DMCONST ParameterMap[] =
      ...
      &CurParams + $M.CVC_HEADSET_2MIC.PARAMETERS.OFFSET_HFK_CONFIG, &ndvc_dm1 + $M.NDVC_Alg1_0_0.OFFSET_CONTROL_WORD,
...
.linefile 1445 "cvc_headset_2mic_config.asm"
...
.linefile 1578 "cvc_headset_2mic_config.asm"
 ...
 .VAR/DM hfk_proc_funcsSnd[] =
      ...
      0;
.linefile 1738 "cvc_headset_2mic_config.asm"
   ...
   .VAR stream_map_left_adc[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      0 ...;
.linefile 1833 "cvc_headset_2mic_config.asm"
   .VAR stream_map_right_adc[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_input_streams_ind,
      0 ...;
.linefile 1851 "cvc_headset_2mic_config.asm"
   .VAR stream_map_sndout[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      0 ...;
.linefile 1873 "cvc_headset_2mic_config.asm"
   .VAR stream_map_rcvin[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_input_streams_ind,
      0 ...;
.linefile 1893 "cvc_headset_2mic_config.asm"
   .VAR stream_map_rcvout[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_output_streams_ind,
      0 ...;
.linefile 1916 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 1994 "cvc_headset_2mic_config.asm"
...
func:
   ...
   rts;
.ENDMODULE;
.linefile 2224 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2338 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2417 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2443 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2476 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2647 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2772 "cvc_headset_2mic_config.asm"
...
$cvc.mc.agc_snd:
   ...
   r0 = r1 AND $M.CVC_HEADSET_2MIC.CONFIG.BYPASS_SNDAGC;
   if NZ rts;
.linefile 2832 "cvc_headset_2mic_config.asm"
...
$cvc.mc.aec500_cng:
.linefile 2988 "cvc_headset_2mic_config.asm"
   jump $cvc.mc.aec500;
...
$cvc.mc.mgdc100:
   ...
   if NZ rts;
.linefile 3013 "cvc_headset_2mic_config.asm"
   r0 = 0;
   r1 = M[$cvc.echo_flag];
...
.ENDMODULE;
.linefile 3138 "cvc_headset_2mic_config.asm"
