.linefile 1 "music_example_resample_gaming.asm"
.linefile 1 "<command-line>"
.linefile 1 "music_example_resample_gaming.asm"
.linefile 15 "music_example_resample_gaming.asm"
...
.linefile 16 "music_example_resample_gaming.asm" 2
...
.linefile 17 "music_example_resample_gaming.asm" 2
...
.CONST $ANALOGUE_IO 8;
.linefile 80 "codec_decoder_faststream.h"
...
.linefile 20 "music_example_resample_gaming.asm" 2
...
.MODULE $dac_resampler;
   ...
   .CONST BUFF_PAD 10;
.linefile 39 "music_example_resample_gaming.asm"
...
.MODULE $adc_resampler;
   ...
   .CONST BUFF_PAD 10;
.linefile 202 "music_example_resample_gaming.asm"
      .CONST TEMP_BUFF_SIZE 216+BUFF_PAD;
  ...
  .VAR/DM adc_iir_temp[TEMP_BUFF_SIZE];
   ...
   .BLOCK mono_copy_switch_op;
      ...
      .VAR mono_copy_switch_op.func = $cbops.switch_op;
      .VAR mono_copy_switch_op.param[$cbops.switch_op.STRUC_SIZE] =
         $adc_resampler.resampler_active,
         mono_resampler_op,
         0,
         $cbops.switch_op.INVERT_CONTROL;
   .ENDBLOCK;
...
.ENDMODULE;
.linefile 298 "music_example_resample_gaming.asm"
...
.ENDMODULE;
.linefile 416 "music_example_resample_gaming.asm"
...
.ENDMODULE;
.linefile 523 "music_example_resample_gaming.asm"
