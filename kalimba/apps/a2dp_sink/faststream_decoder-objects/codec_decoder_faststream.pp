.linefile 1 "codec_decoder_faststream.asm"
.linefile 1 "<command-line>"
.linefile 1 "codec_decoder_faststream.asm"
.linefile 25 "codec_decoder_faststream.asm"
...
.linefile 26 "codec_decoder_faststream.asm" 2
...
.linefile 27 "codec_decoder_faststream.asm" 2
...
.linefile 28 "codec_decoder_faststream.asm" 2
...
.linefile 29 "codec_decoder_faststream.asm" 2
...
.linefile 30 "codec_decoder_faststream.asm" 2
...
.linefile 31 "codec_decoder_faststream.asm" 2
...
.linefile 32 "codec_decoder_faststream.asm" 2
...
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/core_library.h" 1
.linefile 51 "codec_decoder_faststream.asm" 2
...
.linefile 52 "codec_decoder_faststream.asm" 2
...
.linefile 56 "codec_decoder_faststream.asm" 2
...
.MODULE $M.main;
   ...
   .VAR/DMCIRC $audio_out_left[720];
   .VAR/DMCIRC $audio_out_right[720];
   .VAR/DMCIRC $dac_out_left[$OUTPUT_AUDIO_CBUFFER_SIZE];
   .VAR/DMCIRC $dac_out_right[$OUTPUT_AUDIO_CBUFFER_SIZE];

   .VAR/DMCIRC $codec_in[1024];

   .VAR/DMCIRC $audio_in_mono[720];
   .VAR/DMCIRC $codec_out[1024];



   .VAR/DM1CIRC $tone_in[192];
   .VAR/DM1CIRC $tone_in_right[192];
   ...
   .VAR $stereo_tone;
   .VAR $current_adc_sampling_rate = 0;
  ...
  .VAR $stereo_out_copy_struc[] =
   ...
   .BLOCK $audio_out_dc_remove_op_left;
      ...
      .VAR audio_out_dc_remove_op_left.param[$cbops.dc_remove.STRUC_SIZE] =
         ...
         0;
   .ENDBLOCK;
.linefile 353 "codec_decoder_faststream.asm"
   ...
   .BLOCK $audio_mute_op_mono;
        ...
        .VAR $audio_mute_op_mono.param[$cbops.soft_mute_op.STRUC_SIZE_MONO] =
            ...
            0;
    .ENDBLOCK;
.linefile 507 "codec_decoder_faststream.asm"
   ...
   .VAR/DM1 $encoder_codec_stream_struc[$codec.av_encode.STRUC_SIZE] =
      ...
      0,
      0 ...;
.linefile 640 "codec_decoder_faststream.asm"
...
.linefile 782 "codec_decoder_faststream.asm"
...
.linefile 826 "codec_decoder_faststream.asm"
...
wait_for_some_codec_data:
   ...
   frame_loop:
      ...
      call $sra_calcrate;
.linefile 939 "codec_decoder_faststream.asm"
      r8 = &$DecoderMips_data_block;
...
.endmodule;
.linefile 1058 "codec_decoder_faststream.asm"
.MODULE $M.audio_out_copy_handler;
   ...
   if Z jump mono;
.linefile 1087 "codec_decoder_faststream.asm"
   ...
   mono:
.linefile 1104 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 1138 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 1183 "codec_decoder_faststream.asm"
...
.linefile 1279 "codec_decoder_faststream.asm"
   r1 = &$codec_timer_struc;
   r2 = M[$tmr_period_con_copy];
   r3 = &$codec_copy_handler;
   call $timer.schedule_event_in_period;
...
.ENDMODULE;
.linefile 1296 "codec_decoder_faststream.asm"
.MODULE $M.detect_end_of_aux_stream;
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 1361 "codec_decoder_faststream.asm"
.MODULE $M.tone_copy_handler;
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 1414 "codec_decoder_faststream.asm"
...
$set_dac_rate_from_vm:
   ...
   M[$current_adc_sampling_rate] = r1;
   ...
   M[$audio_if_mode] = r0;
.linefile 1444 "codec_decoder_faststream.asm"
   rts;
.ENDMODULE;
.linefile 1464 "codec_decoder_faststream.asm"
.MODULE $M.set_tone_rate_from_vm;
   ...
   rts;
.ENDMODULE;
.linefile 1553 "codec_decoder_faststream.asm"
...
.linefile 1585 "codec_decoder_faststream.asm"
   rts;

.ENDMODULE;
.linefile 1606 "codec_decoder_faststream.asm"
...
$config_rate_matching:
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 1703 "codec_decoder_faststream.asm"
.MODULE $M.apply_hardware_warp_rate;
  ...
  .CONST HW_APPLY_WARP_RATE_TMR_MS 64;
  .CONST HW_APPLY_WARP_MOVING_STEP 64;
  ...
  .VAR $rate_apply_cntr;
   ...
   Null = r0 - ((HW_APPLY_WARP_RATE_TMR_MS*1000)/1000);
   if NEG jump end_hw_rate_apply;
      ...
      r4 = M[$sra_struct + $sra.SRA_RATE_FIELD];
...
.ENDMODULE;
.linefile 1786 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 1841 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 1883 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 1941 "codec_decoder_faststream.asm"
.MODULE $M.conn_init;
...
$conn_init:
   ...
   if NZ jump $error;
      ...
      if NZ jump not_48000;
         ...
         r0 = 1.0884*(((288*1.0)/(2.0*1024))+0.02);
         M[$sra_struct + $sra.TARGET_LEVEL_FIELD] = r0;
