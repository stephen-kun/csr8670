...
.linefile 9 "sr_adjustment.asm" 2
...
.linefile 10 "sr_adjustment.asm" 2
...
.linefile 11 "sr_adjustment.asm" 2
...
.linefile 12 "sr_adjustment.asm" 2
...
.linefile 13 "sr_adjustment.asm" 2
.linefile 23 "sr_adjustment.asm"
...
usb_fix:
   ...
   skip_port_data:
.linefile 411 "sr_adjustment.asm"
   r0 = M[$sra_struct + $sra.CODEC_CBUFFER_TO_TAG_FIELD];
   call $cbuffer.calc_amount_data;
...
.linefile 447 "sr_adjustment.asm"
   r7 = 0.0025;
   NULL = M[$sra_struct + $sra.LONG_TERM_RATE_DETECTED_FIELD];
   ...
   if NEG jump not_full;
      ...
      jump set_final_rate;
   not_full:
.linefile 524 "sr_adjustment.asm"
   r0 = r1 - 0.85;
