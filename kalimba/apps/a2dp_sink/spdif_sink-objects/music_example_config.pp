...
.CONST $sra.NO_ACTIVITY_PERIOD ((50*8000)/8000);
.CONST $sra.ACTIVITY_PERIOD_BEFORE_START ((200*8000)/8000);
...
.linefile 118 "music_example_config.asm"
