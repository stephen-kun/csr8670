...
.linefile 36 "frontend.asm" 2
.linefile 46 "frontend.asm"
...
.MODULE $M.adc_in;
   ...
   .VAR/DMCIRC audio_in_right[320]; .VAR audio_in_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(audio_in_right), &audio_in_right, &audio_in_right;
   .VAR/DMCIRC sidetone_mem[(4*48)]; .VAR sidetone_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(sidetone_mem), &sidetone_mem, &sidetone_mem;
    ...
    .BLOCK sidetone_copy_op;
      ...
      .VAR sidetone_copy_op.param[($cbops.sidetone_filter_op.PEQ_START_FIELD + ($audio_proc.peq.STRUC_SIZE + 2*((3)+1) ))] =
           2,
           5,
           $M.A2DP_LOW_LATENCY_2MIC.CONFIG.SIDETONEENA,
           &$M.CVC.data.CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_ST_CLIP_POINT,
           0,
           0.0,
           0,
           0,
           ...
           0,
           3,
           &$M.CVC.data.CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_ST_PEQ_CONFIG,
           0 ...;
    .ENDBLOCK;
