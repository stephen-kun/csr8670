...
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_handsfree_defaults_wb.dat" 1
...
0x00E2, 0x0079, 0x9999,
0x7999, 0x9900, 0x0001,
0x7333, 0x33FF, 0xFFD8,
0x0000, 0x0120, 0x0000,
0x0000, 0x010C, 0xCCCC,
0x2800, 0x0020, 0x0000,
0x0000, 0x0000, 0x0002,
0x0400, 0x00D1, 0x7E36,
0x1800, 0x0000, 0x0001,
0x0280, 0x00F8, 0x0000,
...
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_handsfree_defaults_fe.dat" 1
...
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/cvc_handsfree_defaults_nb.dat" 1
...
.linefile 136 "cvc_handsfree_config.asm" 2
   ...
   .ENDBLOCK;
    ...
    .ENDBLOCK;
.linefile 261 "cvc_handsfree_config.asm"
   ...
   .VAR dcblock_parameters_wb[] =
        ...
        1;
.linefile 305 "cvc_handsfree_config.asm"
...
.linefile 594 "cvc_handsfree_config.asm"
   ...
   .VAR/DM1 aec_dm1[$M.AEC_500.STRUCT_SIZE] =
      ...
      $M.CVC_HANDSFREE.CONFIG.RERCBAENA,
      0x040000,
      0x200000,
      0,
      2,
   ...
   .VAR/DM1 vsm_fdnlp_dm1[$M.AEC_500_HF.STRUCT_SIZE] =
      ...
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_VSM_HB_TIER1,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_VSM_HB_TIER2,
   ...
   .VAR oms270snd1_obj[$M.oms270.STRUC_SIZE] =
        ...
        1.0,
        0, 0 ...;
.linefile 1098 "cvc_handsfree_config.asm"
...
.linefile 1139 "cvc_handsfree_config.asm"
...
.linefile 1348 "cvc_handsfree_config.asm"
...
.linefile 1506 "cvc_handsfree_config.asm"
      ...
      0;
.linefile 1574 "cvc_handsfree_config.asm"
   ...
   .VAR stream_map_sndin[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_input_streams_ind,
      0 ...;
.linefile 1660 "cvc_handsfree_config.asm"
   .VAR stream_map_sndout[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      0 ...;
.linefile 1686 "cvc_handsfree_config.asm"
   .VAR stream_map_rcvin[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_input_streams_ind,
      0 ...;
.linefile 1706 "cvc_handsfree_config.asm"
   .VAR stream_map_rcvout[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_output_streams_ind,
      0 ...;
.linefile 1729 "cvc_handsfree_config.asm"
...
.ENDMODULE;
.linefile 1807 "cvc_handsfree_config.asm"
...
.linefile 1846 "cvc_handsfree_config.asm"
...
func:
   ...
   rts;
.ENDMODULE;
.linefile 1956 "cvc_handsfree_config.asm"
...
setgains:
   ...
   rts;
.ENDMODULE;
.linefile 2022 "cvc_handsfree_config.asm"
...
func:
   ...
   rts;
.ENDMODULE;
.linefile 2143 "cvc_handsfree_config.asm"
...
.ENDMODULE;
.linefile 2238 "cvc_handsfree_config.asm"
