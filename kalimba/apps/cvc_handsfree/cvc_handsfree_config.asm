...
.CONST $SND_HARMANCITY_HISTORY_EXTENSION  0;
   ...
   .VAR/DM1 AecAnalysisBank[$M.filter_bank.Parameters.TWO_CHNL_BLOCK_SIZE] =
      ...
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_REF_DELAY,  //OFFSET_CH2_DELAY_PTR
...
#if uses_AEC
        &E_real,                // $M.oms270.PTR_X_REAL_FIELD
        &E_imag,                // $M.oms270.PTR_X_IMAG_FIELD
#else
        &D_real,                // $M.oms270.PTR_X_REAL_FIELD
        &D_imag,                // $M.oms270.PTR_X_IMAG_FIELD
#endif
   ...
   .VAR/DM1 aec_dm1[$M.AEC_500.STRUCT_SIZE] =
      ...
      &snd1oms_G,                      // OFFSET_OMS1_G_PTR
      &snd1oms_LpXnz,                  // OFFSET_OMS1_D_NZ_PTR
      &snd1oms_G,                      // OFFSET_oms_adapt_G_PTR
      &snd2oms_G,                      // OFFSET_OMS2_G_PTR
      ...
      $M.CVC_HANDSFREE.CONFIG.RERCBAENA,// OFFSET_RERCBA_ENABLE_MASK    (handsfree)
      0x040000,                        // OFFSET_RER_AGGRESSIVENESS     (handsfree)
   ...
   .VAR/DM1 vsm_fdnlp_dm1[$M.AEC_500_HF.STRUCT_SIZE] =
     ...
     &ZeroValue,
#endif
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_VSM_HB_TIER1, // OFFSET_PTR_TIER1_CONFIG
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_VSM_HB_TIER2, // OFFSET_PTR_TIER2_CONFIG
#if uses_HOWLING_CONTROL
     ...
     $AEC_500.VsmProcess,              // VSM_FUNCPTR
      ...
      &SqGr,                            // OFFSET_PTR_SqGr
      &Attenuation,                         // OFFSET_SCRPTR_Attenuation
      &L_adaptA,                        // OFFSET_SCRPTR_absGr         (shares L_adaptA)
...
#if uses_AEC
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_HFK_OMS_AGGR,     &aec_dm1 + $M.AEC_500.OFFSET_OMS_AGGRESSIVENESS,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_CNG_Q,            &aec_dm1 + $M.AEC_500.OFFSET_CNG_Q_ADJUST,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_CNG_SHAPE,        &aec_dm1 + $M.AEC_500.OFFSET_CNG_NOISE_COLOR,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_DTC_AGGR,         &aec_dm1 + $M.AEC_500.OFFSET_DTC_AGRESSIVENESS,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_MAX_LPWRX_MARGIN, &aec_dm1 + $M.AEC_500.OFFSET_MAX_LPWR_MARGIN,
     #if 0 // SPTBD - removed from xml
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_AEC_REF_LPWR_UB,  &aec_dm1 + $M.AEC_500.OFFSET_AEC_REF_LPWR_UB,
    #endif
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_HFK_CONFIG,      	    &aec_dm1 + $M.AEC_500.OFFSET_CONFIG,
	   &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RER_AGGRESSIVENESS,   &aec_dm1 + $M.AEC_500.OFFSET_RER_AGGRESSIVENESS,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RER_WGT_SY,           &aec_dm1 + $M.AEC_500.OFFSET_RER_WGT_SY,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RER_OFFSET_SY,        &aec_dm1 + $M.AEC_500.OFFSET_RER_OFFSET_SY,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RER_POWER,            &aec_dm1 + $M.AEC_500.OFFSET_RER_POWER,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RER_VAR_THRESH,       &aec_dm1 + $M.AEC_500.OFFSET_RER_VAR_THRESH,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RERDT_OFF_THRESHOLD,    &aec_dm1 + $M.AEC_500.OFFSET_L2TH_RERDT_OFF,
	   &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RERDT_AGGRESSIVENESS,   &aec_dm1 + $M.AEC_500.OFFSET_RERDT_ADJUST,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RERDT_POWER,            &aec_dm1 + $M.AEC_500.OFFSET_RERDT_POWER,

#if uses_NONLINEAR_PROCESSING
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_TIER2_THRESH,         &vsm_fdnlp_dm1 + $M.AEC_500_HF.OFFSET_TIER2_THRESH,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_HD_THRESH_GAIN,       &vsm_fdnlp_dm1 + $M.AEC_500_HF.OFFSET_HD_THRESH_GAIN,
...
#if uses_AEC
      $M.AEC_500.fnmls_process.func,      &aec_dm1,                   0,
#endif
// SPTBD - moved non-linera process before OMS2.  Prevents scratch
// shared by RER,VSM, & FDNL from being corrupted.  Non-Linear
// Processing does not use OMS2 variables and only sets attenuation so
// it does not impact OMS2 operation
#if (uses_HOWLING_CONTROL || uses_NONLINEAR_PROCESSING)
      $AEC_500.NonLinearProcess,      &vsm_fdnlp_dm1,     &aec_dm1,
#endif
...
#if uses_AEC
      $M.AEC_500.comfort_noise_generator.func, &aec_dm1,                   0,
   ...
   // ----------------------------------------------------------------------------
#ifdef uses_SSR // Simple Speech Recognition
...
lp_param_copy:
...
#if uses_SND_NS
    r1 = M[&$M.CVC.data.CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_ASR_OMS_AGGR];
   ...
   r0 = M[&$M.CVC.data.CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_HFK_CONFIG];
   Null = r0 AND $M.CVC_HANDSFREE.CONFIG.CNGENA;
   if Z r1 = Null;
   M[&$M.CVC.data.aec_dm1 + $M.AEC_500.OFFSET_CNG_G_ADJUST] = r1;

   // Configure RER
   r2 = r0 AND $M.CVC_HANDSFREE.CONFIG.RERENA;
...
.CONST $CVC_HF_PERSIST_CURRENT_ALPHA_INDEX_OFFSET                 2;
.CONST $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET                 3;
.CONST $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET                 4;

.CONST $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET                       5;
.CONST $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET                       6;
.CONST $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET               7;
.CONST $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET               8;

.CONST $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET                 9;
.CONST $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET                 10;
...
func:
   ...
   // CURRENT_ALPHA_INDEX
   r0 = M[r3 + $CVC_HF_PERSIST_CURRENT_ALPHA_INDEX_OFFSET];
   M[persistent_current_alpha_index] = r0;

   // AVERAGE_IO_RATIO
   r0 = M[r3 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET];
   r1 = M[r3 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   // WARP_VALUE
   r0 = M[r3 + $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET];
   r1 = M[r3 + $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   // INVERSE_WARP_VALUE
   r0 = M[r3 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET];
   r1 = M[r3 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   // SRA_CURRENT_RATE
   r0 = M[r3 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET];
   r1 = M[r3 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
...
$pblock_send_handler:
   ...
   r0 = M[$pblock_key];   
   M[&persist_data_hf] = r0;

#if uses_RCV_AGC
   r0 = M[$M.CVC.data.rcv_agc400_dm + $M.agc400.OFFSET_G_REAL_FIELD];
   M[$M.hf.LoadPersistResp.persistent_agc]=r0;                    
   ...
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_CURRENT_ALPHA_INDEX_OFFSET] = r0;

   // AVERAGE_IO_RATIO
   r0 = M[$far_end.in.sw_rate_op.param + $cbops.rate_monitor_op.AVERAGE_IO_RATIO_FIELD];
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf  + 1 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET] = r1;

   // WARP_VALUE_FIELD
   r0 = M[$far_end.in.sw_rate_op.param + $cbops.rate_monitor_op.WARP_VALUE_FIELD];
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET] = r1;

   // INVERSE_WARP_VALUE_FIELD
   r0 = M[$far_end.in.sw_rate_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD];
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET] = r1;

   // SRA_CURRENT_RATE
   r0 = M[$far_end.in.sw_copy_op.param + $cbops.rate_adjustment_and_shift.SRA_CURRENT_RATE_FIELD];
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET] = r1;
