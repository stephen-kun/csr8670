...
.linefile 1 "a2dp_low_latency_1mic.h" 1
.linefile 11 "a2dp_low_latency_1mic.h"
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/a2dp_low_latency_1mic_config.h" 1
.linefile 12 "a2dp_low_latency_1mic.h" 2
...
.linefile 13 "a2dp_low_latency_1mic.h" 2
...
.MODULE $M.CVC_MODULES_STAMP;
   ...
   .BLOCK ModulesStamp;
      ...
      .VAR s2 = 0xfeeb;
      .VAR s3 = 0xfeeb;
      .VAR CompConfig = 1*0x040000 + 1*0x020000 + 1*0x010000 + 1*0x008000 + 1*0x004000 + 1*0x002000 + 1*0x001000 + 0*0x000800 + 1*0x000400 + 1*0x000200 + 1*0x000100 + 1*0x000080 + 1*0x000040 + 1*0x000020 + 1*0x000010 + 0*0x000008;
      .VAR s4 = 0xfeeb;
      .VAR s5 = 0xfeeb;
      .VAR s6 = 0xfeeb;
   .ENDBLOCK;
...
.CONST $CVC_ONEMIC_HEADSET_SECID 0x258C;
   ...
   .VAR CVC_config_struct[$M.CVC.CONFIG.STRUC_SIZE] =
      ...
      &$CVC_AppHandleConfig,
      0,
      $CVC_ONEMIC_HEADSET_SECID,
      $CVC_VERSION,
      $M.A2DP_LOW_LATENCY_1MIC.SYSMODE.STANDBY,
      $M.A2DP_LOW_LATENCY_1MIC.SYSMODE.FULLPROC,
      $M.A2DP_LOW_LATENCY_1MIC.SYSMODE.MAX_MODES,
      $M.A2DP_LOW_LATENCY_1MIC.CALLST.MUTE,
      $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.STRUCT_SIZE,
      &$M.CVC.data.CurParams,
      &$M.CVC.data.DefaultParameters_wb,
      $A2DP_LOW_LATENCY_1MIC_SYSID,
      $M.CVC.BANDWIDTH.WB_FS,
      0,
      &$M.CVC.data.StatisticsPtrs,
      &$M.dac_out.auxillary_mix_left_op.param,
      &$M.CVC.data.CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_INV_DAC_GAIN_TABLE;

.ENDMODULE;
.linefile 155 "send_proc.asm"
.MODULE $M.ConfigureSystem;
   ...
   .VAR $pblock_key = ($A2DP_LOW_LATENCY_1MIC_SYSID >> 8) | ($M.CVC.BANDWIDTH.WB_FS / 2000);
...
.linefile 419 "send_proc.asm"
   r2 = $M.CVC.VMMSG.CODEC;
   call $message.send_short;
   jump $pop_rLink_and_rts;

.ENDMODULE;
.linefile 433 "send_proc.asm"
...
$CVC_AppHandleConfig:
   ...
   r1 = r1 AND (~(0x000008));
   r0 = r4 LSHIFT ( round(log2(0x000008)) - 1);
   r0 = r0 AND 0x000008;
   r1 = r1 OR r0;
...
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/a2dp_low_latency_1mic_defaults_FA1M.dat" 1
...
0x4000, 0x0000, 0x8000,
0xFD40, 0x0000, 0x5000,
0x0000, 0x3C7F, 0x9BCE,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000
.linefile 465 "send_proc.asm" 2
   ;
...
.linefile 592 "send_proc.asm"
   ...
   .VAR/DM1 rcv_vad400[$M.vad400.OBJECT_SIZE_FIELD] =
      &vad_peq_output,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_RCV_VAD_ATTACK_TC,
        0 ...;
...
.CONST $SND_HARMONICITY_HISTORY_EXTENSION $M.CVC.Num_Samples_Per_Frame;
   ...
   .VAR/DM1 AecAnalysisBank[$M.filter_bank.Parameters.TWO_CHNL_BLOCK_SIZE] =
      ...
      &stream_map_sndin,
      &stream_map_refin,
      &bufd_inp+$SND_HARMONICITY_HISTORY_EXTENSION,
      &bufx_inp,
      0,
      0,
      &D_real,
      ...
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_REF_DELAY,
      &ref_delay_buffer,
     &ref_delay_buffer,
   ...
   .VAR wnr_obj[$M.oms270.wnr.STRUC_SIZE] =
         ...
         &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_WNR_AGGR,
   ...
   .VAR/DM2 snd_peq_dm2[($audio_proc.peq.STRUC_SIZE + 2*(((5))+1) )] =
      ...
      &stream_map_sndout,
      (5),
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_SND_PEQ_CONFIG,
       0 ...;
   ...
   .VAR/DM1 snd_vad400[$M.vad400.OBJECT_SIZE_FIELD] =
      &vad_peq_output,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_SND_VAD_ATTACK_TC,
      0 ...;
   .VAR vad_hold[$M.CVC.vad_hold.STRUC_SIZE] =
      &snd_vad400 + $M.vad400.FLAG_FIELD,
      &rcv_vad400 + $M.vad400.FLAG_FIELD,
      0,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_SND_AGC_ECHO_HOLD_TIME,
      0 ...;
   ...
   .VAR/DM snd_agc400_dm[$M.agc400.STRUC_SIZE] =
      0,
      $M.A2DP_LOW_LATENCY_1MIC.CONFIG.SND_AGCBYP,
      0,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_SND_AGC_G_INITIAL,
      &stream_map_sndout,
      &stream_map_sndout,
   ...
   .VAR/DMCONST StatisticsPtrs[] =
     ...
     &$M.system_config.data.dac_r_pk_dtct + $M.audio_proc.peak_monitor.PEAK_LEVEL,
      ...
      &$M.CVC.data.CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_CONFIG,
