.linefile 1 "latency_reporting_ll.asm"
.linefile 1 "<command-line>"
.linefile 1 "latency_reporting_ll.asm"
.linefile 11 "latency_reporting_ll.asm"
...
.linefile 12 "latency_reporting_ll.asm" 2
.linefile 38 "latency_reporting_ll.asm"
.MODULE $M.media_packet_boundary_detection;
   .CODESEGMENT PM;
   .DATASEGMENT DM;

   .VAR/DMCIRC $codec_packets_info[50];

   .VAR $codec_packets_info_cbuffer_struc[$cbuffer.STRUC_SIZE] =
         LENGTH($codec_packets_info),
         &$codec_packets_info,
         &$codec_packets_info;
