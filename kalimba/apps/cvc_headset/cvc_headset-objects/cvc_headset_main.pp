...
.linefile 37 "cvc_headset_main.asm" 2
...
.linefile 38 "cvc_headset_main.asm" 2
...
.linefile 39 "cvc_headset_main.asm" 2
...
.linefile 40 "cvc_headset_main.asm" 2
...
.linefile 41 "cvc_headset_main.asm" 2
...
.linefile 42 "cvc_headset_main.asm" 2
...
.linefile 44 "cvc_headset_main.asm" 2
.linefile 1 "cvc_headset.h" 1
.linefile 12 "cvc_headset.h"
...
.linefile 45 "cvc_headset_main.asm" 2
...
.linefile 46 "cvc_headset_main.asm" 2
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/frame_sync_tsksched.h" 1
.linefile 47 "cvc_headset_main.asm" 2
...
.linefile 111 "cvc_headset_main.asm"
.CONST $CVC_ONEMIC_HEADSET_SECID 0x258C;
.linefile 120 "cvc_headset_main.asm"
.MODULE $M.CVC.app.config;
   ...
   .VAR CVC_config_struct[$M.CVC.CONFIG.STRUC_SIZE] =
      &$App.Codec.Apply,
      &$CVC_AppHandleConfig,
      $M.1mic.LoadPersistResp.func,
      $CVC_ONEMIC_HEADSET_SECID,
      $CVC_VERSION,
      $M.CVC_HEADSET.SYSMODE.STANDBY,
      $M.CVC_HEADSET.SYSMODE.HFK,
      $M.CVC_HEADSET.SYSMODE.MAX_MODES,
      $M.CVC_HEADSET.CALLST.MUTE,
      $M.CVC_HEADSET.PARAMETERS.STRUCT_SIZE,
...
$CVC_AppHandleConfig:
   ...
   r1 = r1 AND (~(0x000010));
   r0 = r4 LSHIFT ( round(log2(0x000010)) - 1);
   r0 = r0 AND 0x000010;
   r1 = r1 OR r0;
...
.MODULE $M.ConfigureSystem;
   ...
   .VAR $pblock_key = ($CVC_HEADSET_SYSID >> 8) | ($M.CVC.BANDWIDTH.WB_FS / 2000);
