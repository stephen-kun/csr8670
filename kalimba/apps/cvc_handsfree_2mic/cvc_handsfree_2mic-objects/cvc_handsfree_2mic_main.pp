.linefile 1 "cvc_handsfree_2mic_main.asm"
.linefile 1 "<command-line>"
.linefile 1 "cvc_handsfree_2mic_main.asm"
.linefile 31 "cvc_handsfree_2mic_main.asm"
...
.linefile 32 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 33 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 34 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 35 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 36 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 37 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 38 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 39 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 40 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 41 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 43 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 44 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 45 "cvc_handsfree_2mic_main.asm" 2
.linefile 1 "C:/ADK3.5/kalimba/lib_sets/sdk/include/frame_sync_tsksched.h" 1
.linefile 46 "cvc_handsfree_2mic_main.asm" 2
...
.linefile 110 "cvc_handsfree_2mic_main.asm"
.CONST $CVC_TWOMIC_HANDSFREE_SECID 0xB013;
.linefile 119 "cvc_handsfree_2mic_main.asm"
.MODULE $M.CVC.app.config;
   ...
   .VAR CVC_config_struct[$M.CVC.CONFIG.STRUC_SIZE] =
      &$App.Codec.Apply,
      &$CVC_AppHandleConfig,
      $M.2micHF.LoadPersistResp.func,
      $CVC_TWOMIC_HANDSFREE_SECID,
      $CVC_VERSION,
      $M.CVC_HANDSFREE_2MIC.SYSMODE.STANDBY,
      $M.CVC_HANDSFREE_2MIC.SYSMODE.HFK,
      $M.CVC_HANDSFREE_2MIC.SYSMODE.MAX_MODES,
      $M.CVC_HANDSFREE_2MIC.CALLST.MUTE,
      $M.CVC_HANDSFREE_2MIC.PARAMETERS.STRUCT_SIZE,
      &$M.CVC.data.CurParams,
      &$M.CVC.data.DefaultParameters_wb,
      $CVC_HANDSFREE_2MIC_SYSID,
      $M.CVC.BANDWIDTH.WB_FS,
      &$set_variant_from_vm,
      &$M.CVC.data.StatisticsPtrs,
      &$dac_out.auxillary_mix_op.param,
      &$M.CVC.data.CurParams + $M.CVC_HANDSFREE_2MIC.PARAMETERS.OFFSET_INV_DAC_GAIN_TABLE;

.ENDMODULE;
.linefile 155 "cvc_handsfree_2mic_main.asm"
...
.ENDMODULE;
.linefile 188 "cvc_handsfree_2mic_main.asm"
.MODULE $M.main;
   .CODESEGMENT MAIN_PM;
...
.linefile 227 "cvc_handsfree_2mic_main.asm"
   r2 = $MESSAGE_KALIMBA_READY;
   call $message.send_short;
.linefile 261 "cvc_handsfree_2mic_main.asm"
   call $CVC.Start;
...
.linefile 304 "cvc_handsfree_2mic_main.asm"
...
.ENDMODULE;
.linefile 393 "cvc_handsfree_2mic_main.asm"
...
$audio_config.initialise:
   ...
   jump $pop_rLink_and_rts;
.linefile 470 "cvc_handsfree_2mic_main.asm"
$set_backend_from_vm:
...
.linefile 493 "cvc_handsfree_2mic_main.asm"
$set_front_end_from_vm:
   ...
   jump Signal_system_reconfig;
.linefile 525 "cvc_handsfree_2mic_main.asm"
$set_variant_from_vm:
...
Signal_system_reconfig:
    ...
    rts;
.linefile 550 "cvc_handsfree_2mic_main.asm"
$CVC_AppHandleConfig:
   ...
   r0 = r0 AND 0x100000;
   r1 = r1 OR r0;
   r0 = r4 LSHIFT ( round(log2(0x200000)));
   r0 = r0 AND 0x200000;
   r1 = r1 OR r0;
   M[$M.CVC_MODULES_STAMP.CompConfig] = r1;
   rts;
.ENDMODULE;
.linefile 573 "cvc_handsfree_2mic_main.asm"
...
.ENDMODULE;
.linefile 673 "cvc_handsfree_2mic_main.asm"
...
mode_selected:
.linefile 699 "cvc_handsfree_2mic_main.asm"
   r2 = $M.CVC.VMMSG.CODEC;
   call $message.send_short;
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 713 "cvc_handsfree_2mic_main.asm"
...
.ENDMODULE;
.linefile 763 "cvc_handsfree_2mic_main.asm"
.MODULE $M.ConfigureSystem;
   ...
   .VAR $pblock_key = ($CVC_HANDSFREE_2MIC_SYSID >> 8) | ($M.CVC.BANDWIDTH.WB_FS/2000);
   ...
   .VAR cvc_bandwidth_param_wb[] =
            ...
            0;
.linefile 866 "cvc_handsfree_2mic_main.asm"
$ConfigureSystem:
   push rLink;
